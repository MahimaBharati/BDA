...
public class maxdriver extends Configured implements Tool{ public int run(String[] args)
throws Exception {
...
int res = ToolRunner.run(new Configuration(), new HighestDriver(),args); System.exit(res);
} }